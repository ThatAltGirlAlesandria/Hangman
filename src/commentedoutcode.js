...
// <div> <img id="hangmanImg" alt="Hangman Image"> </div>
// <p id="winningMessage" class="message"></p>
// <div id="keyboard">
...
//     try {
      ...
      // this.secretWord = words[randomWord].word.toUpperCase();
      // this.placeholders = Array(this.secretWord.length).fill("_");
      // this.guesses = 26;
  //     console.log("Game");
  //   } catch (error) {
  ...
  // const secretWords = ["ALESANDRIA", "ALEJANDRA", "AARON", "JADE", "PIER"];
  // let secretWord = "";
  // let placeholders = [];
  // let lives = 10;
  ...
  //   placeholders = Array(secretWord.length).fill('_');
  //   lives = 10;
  // }
  ...
  //   return !placeholders.includes('_');
  // }
...
//       updateGuessCount();
//     }
//     handleLetterClick(letter.target.innerText);
//   });
// });
...
//   for(let i = 0; i < game.placeholders.length; i++) {
//     const span = document.createElement('span');
//     span.textContent = game.placeholders[i];
